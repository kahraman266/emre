				...
				<div id="page" class="dashboard">
                  ...
                  <!-- BEGIN CUSTOM BUTTONS WITH ICONS PORTLET-->
                        ...
                        <div class="widget-body">
                           <div class="row-fluid">
                              ...
                              <a href="urun_listele.php" class="icon-btn span3">
                                ...
                                <a href="hizmet_listele.php" class="icon-btn span3">
                                 <i class="icon-envelope"></i>
                                 <div>Hizmetler</div>
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM hizmetler");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                              ...
                              <div class="row-fluid">
                              <a href="model_kategori_listele.php" class="icon-btn span3">
                                 <i class="icon-bullhorn"></i>
                                 <div>Model Kategori</div>
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM model_kategori");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                                 <span class="badge badge-important"><?=$mevcut?></span>
                              </a>
                              
                              <a href="model_listele.php" class="icon-btn span3">
                                 <i class="icon-envelope"></i>
                                 <div>Modeller</div>
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM model");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                                 <span class="badge badge-info"><?=$mevcut?></span>
                              </a>
                              ...
                              <a href="slider_listele.php" class="icon-btn span3">
                                 <i class="icon-picture"></i>
                                 <div>Slider</div>
                                 <?php
								 $bilgi= mysql_query("SELECT * FROM slider");
								 $mevcut = mysql_num_rows($bilgi);
								 ?>
                                 <span class="badge badge-important"><?=$mevcut?></span>
                              </a>
                     ...
                     <div class="widget" style="width:40%; margin-left:20px; float:left;">
                     	...
                     	<div class="widget-title">
                           <h4><i class="icon-bar-chart"></i> Son Mesajlar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="mesajlar.php"> Tümü</a></h4>
                           <span class="tools">
                           <a href="javascript:;" class="icon-chevron-down"></a>
                           </span>
                        </div>
